...
local user_opts = {
    ...
    boxalpha = 10,              -- alpha of the background box,
...
opt.read_options(user_opts, "flatbox")
...
local osc_styles = {
    bigButtons = "{\\blur0\\bord0\\1c&Hdedede\\3c&HFFFFFF\\fs50\\fnmpv-osd-symbols}",
...
function flatbox()
    ...
    lo.layer = 10
    lo.style = "{\\rDefault\\blur10\\bord5\\1c&H232426\\3c&H232426}"
    lo.alpha[1] = 80
    lo.alpha[3] = 80
    lo.box.radius = 2
    ...
    local pl_style = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&HFFFFFF\\fs30\\fnmpv-osd-symbols}"
    local pl_shift = 165
    lo = add_layout("pl_prev")
    lo.geometry =
        {x = posX - (bigbtndist * 2) - pl_shift, y = bigbtnrowY, an = 5, w = 40, h = 40}
    lo.style = pl_style
    ...
    lo.geometry =
        -- {x = posX, y = posY+pos_offsetY-35, an = 2, w = pos_offsetX*2 - 100, h = 10}
        {x = posX, y = posY - 28, an = 2, w = pos_offsetX*2 + 49, h = 20}
    lo.style = "{\\blur0\\bord0\\1c&Hdedede\\3c&H232426}"
    ...
    local tt_style = "{\\blur0\\bord0\\1c&Hdedede\\3c&Hdedede\\fs20}"

    lo = add_layout("tc_left")
    lo.geometry =
        {x = posX - pos_offsetX + 60, y = bigbtnrowY, an = 4, w = 110, h = 18}
    lo.style = tt_style

    lo = add_layout("tc_right")
    lo.geometry =
        {x = posX + pos_offsetX - 60, y = bigbtnrowY, an = 6, w = 110, h = 18}
    lo.style = tt_style
end
