CJ_COLOR_BLACK='      42  44  65'
CJ_COLOR_DARK_GRAY='  98 102 137'
CJ_COLOR_LIGHT_GRAY='123 127 164'
CJ_COLOR_WHITE='     196 199 218'

CJ_COLOR_RED='       241  93 125'
CJ_COLOR_ORANGE='    234 150 122'
CJ_COLOR_YELLOW='    231 199 138'
CJ_COLOR_GREEN='     153 223 162'
CJ_COLOR_BLUE='      153 172 223'
CJ_COLOR_ELECTRIC='  187 153 223'
