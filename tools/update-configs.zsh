...
sh "${XDG_CONFIG_HOME}/xfce4/terminal/terminalrc.in" > "${XDG_CONFIG_HOME}/xfce4/terminal/terminalrc.new"
mv "${XDG_CONFIG_HOME}/xfce4/terminal/terminalrc.new" "${XDG_CONFIG_HOME}/xfce4/terminal/terminalrc"
